...
actualizarEstado ('Hace click en "Start" para jugar!');
actualizarNumeroRonda('-');
bloquearInputUsuario(); //para que cuendo es el turno de la maquina el usuario no interrumpa
...
function perder() {
    bloquearInputUsuario();
    actualizarEstado('¡Perdiste! tocá "Start" para empezar de nuevo', true);
}